...
import com.jayaprabahar.filmland.monthlysubs.repo.LoginRepository;
...
public class AuthorizationController {
	...
	private GenericResponseDO authorize(@RequestBody LoginRequestDO loginRequestDO) {
		log.info("authorize" + loginRequestDO);

		if (loginRepository.findById(loginRequestDO.getEmail()).filter(e -> e.getPassword().equals(loginRequestDO.getPassword())).isPresent())
